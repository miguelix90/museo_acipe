...
<!-- Buscador -->
<div class="mb-4">
    <form method="GET" action="{{ route('admin.libros.index') }}" class="flex gap-2">
        <div class="flex-1">
            <input type="text" 
                   name="search" 
                   value="{{ $search ?? '' }}" 
        ...
        @if($search)
        <a href="{{ route('admin.libros.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-6 py-2 rounded-lg">
            Limpiar
        </a>
        @endif
    </form>
