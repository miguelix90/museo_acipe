...
<div class="bg-white rounded-lg shadow p-6">
    <h2 class="text-xl font-semibold mb-6">Nuevo Libro</h2>
    ...
    <form action="{{ route('admin.libros.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="fecha_edicion" id="fecha_edicion" value="{{ old('fecha_edicion') }}"
            ...
            <div>
                ...
                <input type="url" name="url_imagen_portada" id="url_imagen_portada" value="{{ old('url_imagen_portada') }}"
            ...
            <div>
                ...
                <input type="url" name="url_resena" id="url_resena" value="{{ old('url_resena') }}"
            ...
            <!-- Imagen Nube de Palabras -->
            <div>
                <label for="imagen_nube_palabras" class="block text-sm font-medium text-gray-700">Imagen Nube de Palabras</label>
